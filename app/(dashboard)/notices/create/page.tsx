...
export default function CreateNoticePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setNotification({ type: "success", message: "Notice published successfully!" });
      ...
      setNotification({ type: "error", message: err.message || "An error occurred while publishing." });
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="max-w-7xl mx-auto space-y-8 py-4 px-2 sm:px-6">
      ...
      <div className="flex items-center justify-between border-b border-slate-150 pb-5">
        ...
        <div className="hidden sm:block">
          <span className="text-2xs font-bold uppercase tracking-wider text-emerald-600 bg-emerald-50 px-3 py-1.5 rounded-xl border border-emerald-100">
            Publish Mode
          </span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 bg-white rounded-3xl p-6 sm:p-8 border border-slate-100 shadow-sm space-y-6">
          <div className="flex items-center gap-2 border-b border-slate-50 pb-4">
            ...
            <h3 className="font-bold text-slate-800">New Notice Draft</h3>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <input
                type="text"
                placeholder="e.g. Admission Open for Academic Session 2026-27"
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                placeholder="Write the announcement instructions or information details..."
                rows={8}
